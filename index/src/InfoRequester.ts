...
class InfoRequester extends EventEmitter {
    ...
    async getBotInfo(botId: number) {
        ...
        .then((data: { avatar: any; owners: any; badges: any; certified: any; approved: any; servers: any; shards: any; name: any; shortDescription: any; description: any; prefix: any; }) => {
            /**
